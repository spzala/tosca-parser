...
from common.exception import InvalidTypeError
from elements.types.attribute_definition import AttributeDef
from elements.types.entitytype import EntityType
from elements.types.property_definition import PropertyDef
