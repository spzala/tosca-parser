...
from parser.elements.types.capabilitytype import CapabilityTypeDef
import parser.elements.types.interfaces as ifaces
...
from parser.elements.types.statefulentitytype import StatefulEntityType
