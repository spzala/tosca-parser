...
from parser.common.exception import InvalidTypeError
from parser.elements.types.attribute_definition import AttributeDef
from parser.elements.types.entitytype import EntityType
from parser.elements.types.property_definition import PropertyDef
