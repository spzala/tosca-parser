...
from parser.elements.templates.parameters import Input
from parser.elements.templates.parameters import Output
from parser.elements.templates.relationship_template import RelationshipTemplate
from parser.tests.base import TestCase
from parser.elements.templates.tosca_template import ToscaTemplate
import parser.utils.yamlparser
...
class ToscaTemplateValidationTest(TestCase):
    ...
    def test_outputs(self):
        ...
        '''
        outputs = (parser.utils.yamlparser.
    ...
    def _custom_types(self):
        ...
        custom_type = parser.utils.yamlparser.load_yaml(def_file)
    ...
    def _single_rel_template_content_test(self, tpl_snippet, expectederror,
                                          expectedmessage):
        rel_template = (parser.utils.yamlparser.
