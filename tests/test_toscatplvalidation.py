...
from elements.templates.nodetemplate import NodeTemplate
from elements.templates.parameters import Input
from elements.templates.parameters import Output
from elements.templates.relationship_template import RelationshipTemplate
from tests.base import TestCase
from elements.templates.tosca_template import ToscaTemplate
...
class ToscaTemplateValidationTest(TestCase):
    ...
    def _custom_types(self):
        ...
        custom_type = utils.yamlparser.load_yaml(def_file)
    ...
    def _single_node_template_content_test(self, tpl_snippet, expectederror,
                                           expectedmessage):
        nodetemplates = (utils.yamlparser.
